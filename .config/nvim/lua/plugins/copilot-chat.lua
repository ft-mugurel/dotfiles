-- This was an package for accessing copilot chat in neovim.
-- It has been removed becouse i started using avante instead.
-- I will keep this here if i strugle with avante and want to go back
-- if i strugle with avante and want to go back to copilot chat.
return {
-- 	{
